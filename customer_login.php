...
?>
<title>IIT(ISM) Dhanbad | Login</title>
...
<style type="text/css">			
	...
	<body>
		...
		<div class="navbar-wrapper" style="height:20vh;">
        ...
        <div class="navbar navbar-inverse nomar" >
          ...
          <div class="navbar-collapse collapse nomar">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href=<?php if(isset($_SESSION['customer_email']))echo "'logout.php'"; else echo "'customer_login.php'"?>><?php if(isset($_SESSION['customer_email']))echo "Logout"; else echo "Login"?></a></li>
  ...
  -webkit-background-clip: text;">Canteen - IIT(ISM) Dhanbad</h1>
        </header> 
      </div>
    </div>
		<!--Navigation Bar ends-->
		...
		<div class="container">
    <h1 class="welcome text-center" align="center" style="color: black">Welcome</h1>
        <div class="card card-container">
        <h2 class='login_title text-center' align="center" style="color: darkgrey">Login</h2>
       

            <form class="form-signin" method="POST">
                <span id="reauth-email" class="reauth-email"></span>
                <p class="input_title">Username / Admission Number</p>
                <input type="text" name="prn" class="login_box" placeholder="20JE####" required autofocus>
                <p class="input_title">Password</p>
                <input type="password" name="pass" class="login_box" placeholder="******" required>
                <div id="remember" class="checkbox">
                    
                </div>
                <center><input class="btn btn-lg btn-signin" type="submit" name="login" style="color: white;width:50%;margin:5px;" value="Login"></center>
			<p align="center"><a href="customer_register.php" style="text-decoration: none;">New? Register Here</a></p>
