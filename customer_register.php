...
<html>
	<head>
		<title>IIT(ISM) Dhanbad | Signup</title>
...
<body>
  ...
  -webkit-background-clip: text;">Canteen - IIT(ISM) Dhanbad</h1>
	...
	<br
        ...
        <h2 class='login_title text-center' align="center" style="color: black">Enter Details </h2>
       

            <form class="form-signin" method="POST">
               
                <p class="input_title">Name</p>
                <input type="text" name="c_name" class="login_box" placeholder="Name" required autofocus>
                <p class="input_title">E-mail</p>
                <input type="email" name="c_email" class="login_box" placeholder="name@example.com" required>
                <p class="input_title">Contact Number</p>
                <input type="text" name="c_contact" class="login_box" placeholder="7069####11" required>
                <p class="input_title">Username or Admission Number</p>
                <input type="text" name="c_prn" class="login_box" placeholder="20JE####" required >
				...
				<div style="text-align: center">
					<input class="btn btn-lg btn-signin" type="submit" name="register" value="Register" style="color: white;width:50%">
				</div>
				<p style="margin:10px 0 0 0;" align="center"><a href="customer_login.php" style="text-decoration: none;">Login</a></p>
            </form><!-- /form -->
        </div><!-- /card-container -->
    </div><!-- /container -->	
